...
6. [Enhanced Feedback Glow](#enhanced-feedback-glow): Highlights assignments that have grader feedback and adds a direct feedback link.
...
2. Click `Assignments` (`/courses/<course_id>/assignments`).
3. Look for assignments with a soft highlight and a pulsing `View Feedback` link.
4. Click `View Feedback` to open your submission details and grader feedback for that assignment.
